...
const { data: product } = await http<Product>(`products/${id}`, {
  server: true
})
      ...
      <section class="right-side">
        ...
        <div class="d-flex items-center star-and-b">
          ...
          <div class="px-2 d-flex gap-2 items-center">
            ...
            <span class="text-18 d-none-sm"
              >{{ product.rating.count }} people who rate this</span
            >
          </div>
        </div>
        <div class="description">
          ...
          <div class="add-to-card">
            <button
              class="btn btn-primary d-flex items-center gap-2 text-22"
              @click="addItemToCart"
            >
