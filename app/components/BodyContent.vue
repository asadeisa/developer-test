...
const { data: offers } = http<any>(`products?limit=10`, {
  lazy: true,
  deep: false
})
const { data: newArrival } = http<any>(
  `products/category/women's clothing?limit=10`,
...
<template>
  ...
  <section class="all-page-image cover">
    <NuxtImg
      loading="lazy"
  ...
  <section class="offers container-fluid">
    ...
    <ClientOnly>
      <SharedCustomSlider
        :products="newArrival"
        :breakpoints="ArrivalBreakPoints"
        :show-navigation="false"
        :show-pagination="false"
        :wrap-around="false"
        :autoplay="0"
  ...
  <section class="be-a-member d-flex justify-content-center">
    <h2 class="text-30 text-uppercase mb-0">become a member & get 15% off</h2>
    <button class="btn btn-primary text-uppercase text-bold text-18">
