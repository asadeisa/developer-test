  ...
  <div>
    <header class="container-fluid d-flex flex-column">
      ...
      <div class="d-flex align-items-center justify-content-between">
        <nav
          class="navbar pt-0 navbar-light w-100 align-items-end justify-content-between"
        >
          ...
          <div class="other-logo">
            <div
              class="collapse d-flex align-items-center navbar-collapse justify-content-between show"
            >
              <SharedCustomSelect
                class="select-cat-sm"
                ...
                :haveSearch="false"
                @item-is-select="selectCat"
                mainKey="name"
              />
              <ul
                class="navbar-nav d-flex flex-row list-nav-header mb-2 mb-lg-0 text-20 h-sm-screen"
              >
              ...
              <div class="d-flex align-items-center">
                <form class="d-flex">
                  ...
                  >
                    ...
                    <span @click.stop="showSmSearch = false" class="close-sm"
                      >X</span
                    >
                  </div>
                </form>
