...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "4886dea1-2efb-408e-bf9f-399391bde49a",
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"D:\\projects\\شركه حلول التكنولوجيا\\code\\.data\\kv"}));
...
const _vYZpxvHPpj = defineNitroPlugin((nitro) => {
...
const _lazy_TdQUi8 = () => import('../routes/renderer.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_TdQUi8, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_TdQUi8, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch as $, deleteCookie as A, getContext as B, withTrailingSlash as C, withoutTrailingSlash as D, defu as E, withLeadingSlash as F, parseURL as G, baseURL as H, createHooks as I, toRouteMatcher as J, createRouter$1 as K, hash as L, getQuery as a, buildAssetsURL as b, createError$1 as c, defineRenderHandler as d, getRouteRules as e, useRuntimeConfig as f, getRouteRulesForPath as g, getResponseStatusText as h, getResponseStatus as i, joinHeaders as j, parseQuery as k, destr as l, klona as m, normalizeCookieHeader as n, hasProtocol as o, publicAssetsURL as p, isScriptProtocol as q, joinURL as r, parse as s, getRequestHeader as t, useNitroApp as u, isEqual as v, withQuery as w, sanitizeStatusCode as x, setCookie as y, getCookie as z };
