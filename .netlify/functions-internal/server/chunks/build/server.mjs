import { defineAsyncComponent, defineComponent, ref, h, resolveComponent, hasInjectionContext, inject, Fragment, Comment, computed, useAttrs, mergeProps, unref, getCurrentInstance, watchEffect, watch, version, provide, shallowReactive, Suspense, useSSRContext, createApp, withCtx, createVNode, toRef, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, nextTick, getCurrentScope } from 'vue';
import { k as parseQuery, l as destr, m as klona, c as createError$1, o as hasProtocol, q as isScriptProtocol, r as joinURL, s as parse, t as getRequestHeader, v as isEqual, w as withQuery, x as sanitizeStatusCode, y as setCookie, z as getCookie, A as deleteCookie, B as getContext, C as withTrailingSlash, D as withoutTrailingSlash, E as defu, F as withLeadingSlash, G as parseURL, $ as $fetch, H as baseURL, I as createHooks, J as toRouteMatcher, K as createRouter$1 } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "cart",
    path: "/cart",
    component: () => import('./cart-vzxbNNOs.mjs')
  },
  {
    name: "category-name",
    path: "/category-:name()",
    component: () => import('./category-_name_-BKn8Lww1.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-B8ns043c.mjs')
  },
  {
    name: "product-id",
    path: "/product-:id()",
    component: () => import('./product-_id_-C7IneKum.mjs')
  }
];
...
const nuxt_plugin_6wEQMY3tee = /* @__PURE__ */ defineNuxtPlugin(async (nuxtApp) => {
  ...
  const hydrationMode = useState("nuxt-delay-hydration-mode", () => mode);
  {
    ...
    if ((_c = (_b = (_a = event == null ? undefined : event.context) == null ? undefined : _a._nitro) == null ? undefined : _b.routeRules) == null ? undefined : _c.delayHydration)
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BptYYDQO.mjs').then((m) => m.default || m))
};
...
const __nuxt_component_2$1 = defineAsyncComponent({
  loader() {
    const hydrationApi = Promise.resolve();
    return new Promise((resolve) => {
      hydrationApi.then(() => {
        resolve((props, { slots }) => {
          var _a;
          return h(Fragment, [h(Comment, "nuxt-delay-hydration-component"), (_a = slots.default) == null ? undefined : _a.call(slots, props)]);
        });
      });
    });
  },
...
const twicpicsRuntime$Yvzwkt4RWh = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  getImage
...
imageOptions.providers = {
  ["twicpics"]: { provider: twicpicsRuntime$Yvzwkt4RWh, defaults: { "baseURL": "" } }
};
const useImage = () => {
  const config = /* @__PURE__ */ useRuntimeConfig();
  const nuxtApp = useNuxtApp();
...
const __nuxt_component_2 = Object.assign(_sfc_main$4, { __name: "NuxtImg" });
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "footer" }, _attrs))}><div class="footer-wrapper d-flex flex-wrap container-fluid"><section class="footer-logo d-flex flex-column"><div class="cover logo-f">`);
  ...
  _push(`</div><div class="socials d-flex"><span class="cover">`);
  ...
  _push(`</span></div></section><section class="footer-nav"><p class="text-22"> Home</p><p class="text-22"> About us</p><p class="text-22"> Media center</p><p class="text-22"> Contact Us</p></section><section class="footer-category"><p class="text-22"> Electronics</p><p class="text-22"> Jwelery</p><p class="text-22"> Men Clothing</p><p class="text-22"> Women Clothing</p></section><section class="footer-contact"><h3 class="text-bold text-30">Contact us</h3><p class="text-22 curser-none"> +971 00 000 0000</p><p class="text-22 curser-none"> +971 00 000 0000</p><p class="text-22">info@sample.com</p></section></div><hr><div class="copy-rights"><p class="text-20 text-capitalize text-center"> © developer test 2024. all rights reserved </p></div></footer>`);
}
...
const __nuxt_component_4 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender]]), { __name: "FooterApp" });
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_DelayHydration = __nuxt_component_2$1;
      const _component_FooterApp = __nuxt_component_4;
      ...
      _push(ssrRenderComponent(_component_DelayHydration, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_FooterApp, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_component_FooterApp)
            ];
          }
        }),
        _: 1
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const _Error404 = defineAsyncComponent(() => import('./error-404-CiJ5ZymD.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-cnhqX4AO.mjs'));
...
export { _export_sfc as _, __nuxt_component_0$1 as a, __nuxt_component_2 as b, useRoute as c, __nuxt_component_2$1 as d, entry$1 as default, useCookie as e, useNuxtApp as f, asyncDataDefaults as g, createError as h, fetchDefaults as i, useRequestFetch as j, navigateTo as n, useHead as u };
